...
-(void)transitIn
{
	...
	*/
	...
	//
	rowOneTween.onComplete = ^(){
        [self onSingleTransitionInComplete];
    };
	rowTwoTween.onComplete =^(){
        [self onSingleTransitionInComplete];
    };
     
	rowThreeTween.onComplete = ^(){
        [self onSingleTransitionInComplete];
    };
    
	rowFourTween.onComplete = ^(){
        [self onSingleTransitionInComplete];
    };
    
	rowFiveTween.onComplete = ^(){
        [self onSingleTransitionInComplete];
    };
    
	rowSixTween.onComplete = ^(){
        [self onSingleTransitionInComplete];
    };
    
	rowSevenTween.onComplete = ^(){
        [self onSingleTransitionInComplete];
    };
    
	rowEightTween.onComplete = ^(){
        [self onSingleTransitionInComplete];
    };
...
-(void)transitOut
{
	...
	//
	rowOneTween.onComplete = ^(){
        [self onSingleTransitionOutComplete];
    };
	rowTwoTween.onComplete = ^(){
        [self onSingleTransitionOutComplete];
    };
